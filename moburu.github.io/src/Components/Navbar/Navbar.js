    ...
    render() {
        return (
            <nav className="Navbar">
                ...
                <a href="/#" className="toggle-button" onClick={this.handleClick1}>
                ...
                <ul className='links'>
                    ...
                    <li id='last-link' className='resume'><a href="StevenSchiffnerResume.pdf" download>Resume</a></li>
                    {/* <li className='link'><a href="https://www.linkedin.com/in/steven-schiffner-b972b5163/" target="_blank" rel="noreferrer">LinkedIn</a></li>
                    <li className='link'><a href="https://github.com/Moburu" target="_blank" rel="noreferrer">GitHub</a></li> */}
                </ul>
            </nav>
        );
    }
